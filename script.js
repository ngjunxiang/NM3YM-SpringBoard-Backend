...
db.Users.insertMany([
    ...
    { "username": "NgJunXiang", "password": "$argon2i$v=19$m=512,t=2,p=2$r2ZuDjspB02UKmaxCB1Dbg$A3vIULuZQ8LX+KwMOk+i3Q", "userType": "COM", "name" : "Ng Jun Xiang", "email": "junxiang@email.com" }
])
